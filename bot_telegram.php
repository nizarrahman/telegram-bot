...
$token = "5581488195:AAEddoS3wD73Bp9Q77r4gyzNVoG7TM4DTcU";  // isi token bot di sini
$username_dev = "@nizar901";
$versi_bot    = "1.0";                                      // sesuaikan dengan tahap pengembangan dan fitur
$offset       = 0;                                          // mula - mula data input dimulai dari 0

echo "Memulai Bot Nai Store\n";
...
system('clear');
echo "Bot telah diaktifkan Developer By @nai_developer\n";
